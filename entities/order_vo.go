...
type TransactionRecordVO struct {
	...
	WalletID                uint64           `json:"walletId,string,omitempty"` //可能為空
	...
	FromWalletID            uint64           `json:"fromWalletId,string,omitempty"`            //可能為空
	...
	ToWalletID              uint64           `json:"toWalletId,string,omitempty"`              //可能為空
